...
yoffset=-4
cbdataset=train-val # complete # used only for LQP Features. This is used to choose subset of dataset for codebook learning e.g. in case of LFW it can be either view1 training validation ('train-val') subset or complete view1 set('complete') 
...
dist=cosine # Distance metric for comparing features. Available options are cosine, chi-square and L2
