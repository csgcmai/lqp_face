...
[General] 
#general options
idir=/home/hussain/datasets/LFW/lfw2/ # path of the folder where LFW-Aligned images have been extracted
odir=/scratch/testing/experiments/ # path where cropped_images, learned model
...
view=complete # Choice of the dataset, options cans be view1: used for
